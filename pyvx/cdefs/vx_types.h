...
enum vx_action_e {
    ...
    VX_ACTION_COMPLETE  = VX_ENUM_BASE(VX_ID_KHRONOS, VX_ENUM_ACTION) + 0x2,
};
...
enum vx_reference_attribute_e {
    ...
    VX_REFERENCE_IS_INVALID = VX_ATTRIBUTE_BASE(VX_ID_KHRONOS, VX_TYPE_REFERENCE) + 0x3,
...
enum vx_node_attribute_e {
    ...
    /*! \brief Indicates the property string of node.
     * Read-Write. Can be written only at user-node (de)initialization if VX_KERNEL_XXX==0.
     * Use a void * parameter.
     */
    VX_NODE_PROPERTY_STRING = VX_ATTRIBUTE_BASE(VX_ID_KHRONOS, VX_TYPE_NODE) + 0x9,
    /*! \brief Indicates the node run controlled by condition.
     */
    VX_NODE_CONDITION = VX_ATTRIBUTE_BASE(VX_ID_KHRONOS, VX_TYPE_NODE) + 0xA,
    VX_NODE_LOOP_COUNT = VX_ATTRIBUTE_BASE(VX_ID_KHRONOS, VX_TYPE_NODE) + 0xB,
};
...
enum vx_scalar_attribute_e {
    ...
    VX_SCALAR_ITEMSIZE = VX_ATTRIBUTE_BASE(VX_ID_KHRONOS, VX_TYPE_SCALAR) + 0x1,
};
...
typedef struct _vx_imagepatch_addressing_t {
    ...
    vx_uint16 step_y;       /*!< \brief Step of Y dimension in pixels. */
