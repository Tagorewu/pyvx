 ...
 * \ingroup group_control_flow
  */
VX_API_ENTRY vx_node VX_API_CALL vxIfBranchNode(vx_graph graph, vx_scalar condition, vx_reference input, vx_reference then_value, vx_reference else_value);
...
*/
VX_API_ENTRY vx_node VX_API_CALL vxLBPNode(vx_graph graph, vx_image _in, vx_enum format, vx_int8 kernel_size, vx_image out);
